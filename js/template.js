$( document ).ready(function () {
    ...
    $("#topNavigation").html('<nav>'
	    	...
	    	+ '</a>'
	    	+ '<a href="06_contact.html" class="navigationButton-a">'
	    		+ '<img src="img/icon/Gmail.png" class="topIcon" alt="Gmail">'
	    	+ '</a>'
	    	+ '<a href="#"" class="navigationButton-b">My Account</a>'
	    	+ '<a href="07_order.html" class="navigationButton-a" id="viewCart">View Cart (0)'
